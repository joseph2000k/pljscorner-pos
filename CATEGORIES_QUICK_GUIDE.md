# Quick Start Guide: Categories Feature
...
4. Tap a category to select it (turns blue)
5. Or tap "Manage Categories" to add new ones
6. Save the product
...
💡 Can't delete a category if products are using it
💡 Access categories from both home screen and add product form
